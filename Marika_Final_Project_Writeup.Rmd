...
```{r fig.align='center'}
vcd::mosaic(STATUS_CLASSIFICATION ~ BOROUGH, sidewalks,rot_labels=c(90,90,0,0),just_labels=c("left","right","right","right"),labels=TRUE, varnames=FALSE)
```
The mosaic plot shows how Bronx and Brooklyn may be getting more new license requests. Interestingly, Bronx is also getting the highest percentage of renewal requests. 
